...
\FIXME{Tienes que poner alguna cita más sobre el problema de las distracciones,
  legislación al respecto, estudios, etc.}

\FIXME{También tienes que citar algún trabajo que ataque el mismo problema y comentarlo
  brevemente}
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=0.52\textwidth]{girar-izquierda.png}
