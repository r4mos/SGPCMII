...
Las coordenadas geográficas son el sistema que nos permite representar nuestra posición en el
...
\begin{definitionlist}
  \item[Google maps] Google Maps es una aplicación de navegación lanzada por Google en septiembre de
    ...
    \begin{itemize}
      ...
      \item «Street View» o posibilidad de ver fotografías de las calles.
